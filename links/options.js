...
document
  ...
  .setAttribute("value", localStorage.getItem("grad1"));
document
  .getElementById("grad2")
  .setAttribute("value", localStorage.getItem("grad2"));
document
  .getElementById("deg")
  .setAttribute("value", localStorage.getItem("deg"));
document
  .getElementById("text")
  .setAttribute("value", localStorage.getItem("text"));
document
  .getElementById("gavel")
  .setAttribute("value", localStorage.getItem("gavel"));
document
  .getElementById("flagchange")
  .setAttribute("value", localStorage.getItem("flagchange"));
document
  .getElementById("logourl")
  .setAttribute("value", localStorage.getItem("logourl"));
document
  .getElementById("flagurl")
  .setAttribute("value", localStorage.getItem("flagurl"));
document
  .getElementById("countval")
  .setAttribute("value", localStorage.getItem("countval"));
